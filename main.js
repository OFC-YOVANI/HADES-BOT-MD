...
global.authFile = `Hades-Session-data.base`
...
function purgeSession() {
    let prekey = []
    let directorio = readdirSync("./Hades-Session-data.base")
...
let listaDirectorios = readdirSync('./src/Hades-Serbot/');
...
const directories = ['./Hades-Session-data.base/', './src/Hades-Serbot/']
