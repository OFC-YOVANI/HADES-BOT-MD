...
await conn.sendButton(m.chat, `*Hᴀsᴛᴀ ʟᴀ ᴘʀᴏxɪᴍᴀ👋*, ${await this.getName(m.sender)} *ʟᴇ❗ɪɴғᴏʀᴍᴏ ǫᴜᴇ ʜᴀ ʀᴏᴍᴘɪᴅᴏ ʟᴀs ʀᴇɢʟᴀs sᴇʀᴀ ᴇʟɪᴍɪɴᴀᴅᴏ ᴅᴇ ɪɴᴍᴇᴅɪᴀᴛᴏ ☘️*${isBotAdmin ? '' : '\n\n*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝙻 𝙱𝙾𝚃 𝙽𝙾 𝙴𝚂 𝙰𝙳𝙼𝙸𝙽, 𝙽𝙾 𝙿𝚄𝙴𝙳𝙴 𝙴𝚇𝚃𝙴𝚁𝙼𝙸𝙽𝙰𝚁 𝙰 𝙻𝙰𝚂 𝙿𝙴𝚁𝚂𝙾𝙽𝙰𝚂*'}`, author, ['𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁 𝙰𝙽𝚃𝙸𝙻𝙸𝙽𝙺𝚂', '/disable antilink'], m)    
