...
if (!chat.isBanned && chat.audios && m.text.match(/(sad|🥺|😔|😭|que triste|es estoy triste)/gi)) {
let vn = './media/triste.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(no trabajo|descanso|mañana no trabajo|Hoy es sábado)/gi)) {
